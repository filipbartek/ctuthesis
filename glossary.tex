...
\newacronym[parent=sot]{kbo}{KBO}{Knuth-Bendix \glslink{to}{ordering}}
\newacronym[parent=sot]{lpo}{LPO}{lexicographic path \glslink{to}{ordering}}
...
% AutoML
\newacronym{ac}{AC}{algorithm configuration}
\newacronym{aac}{AAC}{automated \acrlong{ac}}
...
\newacronym{par}{PAR}{penalized average \gls{runtime}}
