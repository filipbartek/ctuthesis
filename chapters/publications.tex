...
%publications excerpted by WoS and others; (in case the share of all co-authors is not
...
\Acrshort{ijcar} & 2024 & \corehref{1314}{A} & \woshref{001273489700012}{\checkmark} & 5 & 2 & \ref{sec:results:regularization} & \cite{DBLP:conf/ijcar/BartekCS24} \\
...
The numbers of citations were collected from \href{https://scholar.google.com/}{Google Scholar} on \DTMdisplaydate{2025}{3}{21}{-1}.
...
\item[Public acceptance] \citations{5}{2}{IjCSPb-OGe4C}{14661423119916603256}
