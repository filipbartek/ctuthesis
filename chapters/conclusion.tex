...
\todo[inline,color=green]{Reworked section}
...
the paradigm, with appropriate modifications, has also been successfully applied to \gls{hol} \cite{DBLP:conf/ijcar/BhayatS24}\todo[color=green]{Reference more papers on saturation-based proving for HOL.}.
All of the heuristic optimization\todo{Ambiguous: optimization of heuristics, or optimization by heuristics?} techniques I introduced in this thesis are of potential use in saturation-based proving in \gls{hol}.
...
It would be particularly interesting to compare the specifics of the domains with respect to schedule optimization.
