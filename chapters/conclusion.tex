...
such as mathematics\todo{Reference Mizar Math Library (MPTP 0.2 (2016)), Isabelle (Seventeen), ...} or software verification,
...
It would be especially interesting to compare the specifics of the domains with respect to schedule optimization.\todo{Reference COSEAL or some related research.}
