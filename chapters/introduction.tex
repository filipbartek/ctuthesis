...
-- a set of clauses that have been used exhaustively as premises of inference rules to derive new clauses -- and the \defn{unprocessed set} -- a set of clauses that have been transitively inferred from the input clauses and have not been used as premises of inferences.\todo[color=green]{new definition of processed and unprocessed set}
%deriving new facts,
