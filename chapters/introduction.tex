...
The signature is a set of non-logical\todo{Contrast with logical symbols -- connectives and quantifiers.} symbols -- predicates\todo[color=green]{Identifiers of predicates, or predicates?} and functions.
...
some common theories\todo[color=green]{This "theory" is not a set of axioms, it's a theory in a less formal sense. Disambiguate. Does "axiomatizable theory" even make sense?} axiomatizable in \gls{fol} include set theory, group theory, and arithmetic.\todo[color=green]{new paragraph}
...
-- a set of clauses that have been used exhaustively as premises of inference rules to derive new clauses -- and the \defn{unprocessed set} -- a set of clauses that have been transitively inferred from the input clauses and have not been used as premises of inferences.
%deriving new facts,
