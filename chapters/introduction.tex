...
For example, both the ordered resolution calculus \cite{} (a subset\todo[color=green]{Is ordered resolution really a subset of superposition calculus? Or does Vampire implement the union of these calculi?} of the superposition calculus \cite{} which is implemented in Vampire)
are parameterized by a \defn{literal selection function} -- a function that selects a subset of literals in each clause.
