...
\todo[inline,color=yellow]{Reference \href{https://github.com/IBM/TRAIL}{TRAIL}.}
...
or all literals that are maximal with respect to the \gls{to} are selected.\todo[author=MS,color=green]{Literal selection is another standalone restriction of the calculus, which just needs to be compatible with the ordering for completeness. Tedy rikat, ze ordering (jen ten) restringuje kalkulus dvema zpusoby je nepresne.\\
FB: Nerozumim dostatecne, pobavme se o tom osobne.}
