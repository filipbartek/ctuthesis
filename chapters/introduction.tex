...
In the 20th century,
Zermelo--Fraenkel set theory emerged as the standard foundational theory,
and classical \gls{fol} was established as a suitable formalism for expressing the axioms and theorems of the theory \cite{DBLP:journals/bsl/Ferreiros01}\todo{Is this citation relevant enough?}.\todo[color=green]{reworded sentence}\todo{This paragraph repeats \enquote{mathematics} many times.}
...
to work as premises of all the inference rules in the calculus implemented by the prover.
...
For this reason, a successful inference calculus restricts the inferences as much as possible while maintaining its completeness.
...
Vampire uses a \gls{sot} \cite{DBLP:journals/logcom/BachmairG94}\todo{Make sure the cited text discusses "simplification ordering". Consider citing Term rewriting and all that.} to restrict the proof search without compromising completeness:
\begin{enumerate}
