...
I invite readers interested in more details to consult relevant literature on \gls{logic} \cite{DBLP:books/daglib/0072413} and \gls{ar} \cite{}.\todo[color=green]{Add more references for both logic and AR.}
...
\todo[inline]{New introductory paragraph. Moved from chapter Results.}
...
Furthermore, they are potentially useful in other areas of parameterized problem solving, as detailed below\todo{Where? Make sure it is actually discussed.}.
