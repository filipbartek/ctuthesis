...
\todo[inline,color=green]{Consider promoting the paper sections to chapters.}
...
\todo[inline,color=green]{This section is new and RC.}
...
I trained a \gls{gnn} to predict a score\todo[color=green]{The paper uses \enquote{symbol cost} and \enquote{precedence cost}. Is the discrepancy justified?} for each symbol in the signature such that ordering the symbols by their scores yields a good \gls{sp} for \gls{kbo} in Vampire.
