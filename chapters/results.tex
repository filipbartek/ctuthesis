...
by a method that approximately optimizes the total preference value of pairs of symbols consistent with the precedence.\todo[color=yellow]{Unclear. Reword, clarify, make this easier to understand. MS: Smells like cyclic definition superficially.}
\end{enumerate}
