...
\todo[inline]{Reference CIIRC as the workplace, preferably on the title page.}
...
\todo[inline]{Mention algorithm configuration in the SOTA section.}
\todo[inline]{Compare FOL reasoning to SAT solving.}
\todo[inline]{Reasoning is proving validity or satisfiability.}
\todo[inline]{undecidability, incompleteness}
