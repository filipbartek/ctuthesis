...
\newcommand{\citations}[4]{\href{https://scholar.google.com/scholar?cites=#4}{Number of citations\footnote{\scholar{} Excluding self-citations (citations from a publication with a shared author).}: #2}}
...
All of the publications included in this section are related to the topic of this dissertation thesis.
