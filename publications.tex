...
\item \auth{Filip Bártek}, Karel Chvalovský, and Martin Suda. Regularization in Spider-Style Strategy Discovery and Schedule Construction. \Gls{ijcar} 2024. \cite{DBLP:conf/ijcar/BartekCS24}\todo{If this paper gets indexed in WoS, move it to \cref{sec:wos}.}
\\
\core{2023}{A}{1314}. See \cref{sec:results:regularization}.

\item \auth{Filip Bártek}, Karel Chvalovský, and Martin Suda. Cautious Specialization of Strategy Schedules. \Gls{paar} 2024. \cite{DBLP:conf/paar/BartekC024}
